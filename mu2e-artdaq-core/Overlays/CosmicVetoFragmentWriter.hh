...
mu2e::CosmicVetoFragmentWriter::CosmicVetoFragmentWriter(artdaq::Fragment& f ) :
  ...
  //  DetectorFragment(f), artdaq_Fragment_(f) {
	...
	throw cet::exception("CosmicVetoFragmentWriter: Raw artdaq::Fragment object size suggests it does not consist of its own header + the DetectorFragment::Metadata object");
      }
